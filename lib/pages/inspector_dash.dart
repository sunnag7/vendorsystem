...
class InspectorDash extends StatefulWidget{
  const InspectorDash({super.key});


  @override
  State<StatefulWidget> createState() {
    return InspectorDashState();
  }
}

class InspectorDashState extends State<InspectorDash>{
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                title: Text('Requested Quotes', style: TextStyle(fontSize: _drawerFontSize, color: Theme.of(context).accentColor),
                ),
                onTap: () {
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: MaterialButton(
                        ...
                        splashColor: Colors.redAccent,
                        child: const Text("View Requested Quotes"),
                      )),
                ],
              ),
              Row(
